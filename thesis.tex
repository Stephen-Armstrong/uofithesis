...
% Chapters make up the Main Text. Always use sectioning commands to create chapters, 
% sections, etc. Do not use formatting commands to make regular text look like 
% a chapter heading, as this will not be tagged properly for accessibility.
...
% For an appendix without the chapter numbering, use \chapter* and add it to 
% the table of contents manually with \addcontentsline
\chapter*{Appendix A: Coffee Survey}
\addcontentsline{toc}{chapter}{Appendix A: Coffee Survey}
